          ...
          <section className="mx-auto flex w-full max-w-6xl flex-col gap-8">
            <div className="text-center space-y-3">
              <h1 className="text-3xl sm:text-4xl font-semibold text-slate-50 flex items-center justify-center gap-3">
                <FiUsers className="h-8 w-8 text-orange-300" />
                Leadership Team
              </h1>
              <p className="text-sm sm:text-base text-slate-100/80 max-w-2xl mx-auto">
                The Leadership Team provides strategic leadership, governance and day-to-day coordination
            ...
            <div className="grid gap-5 sm:grid-cols-2 lg:grid-cols-3 text-sm">
              ...
              {/* 2. Vice President and Co-Founder (General / Deputy President) */}
              <a
              ...
              {/* 4. Dr. Sylvanus - Director of Research, Training and Capacity Building */}
              <a
              ...
              {/* 5. Ndifor - Director of Adolescent & Youth Mentoring Services */}
              <a
              ...
              {/* 7. Director of Public Engagement & Strategic Partnerships */}
              <a
              ...
              {/* 9. Coordinator – Digital Communications and Protocol */}
              <a
