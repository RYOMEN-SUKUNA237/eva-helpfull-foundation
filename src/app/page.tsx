          ...
          <Reveal as="section" className="max-w-6xl mx-auto space-y-6" id="blog">
            ...
            <div className="grid gap-5 md:grid-cols-3">
              ...
              <article className="glass-panel flex flex-col p-5 text-sm">
                ...
                <h3 className="text-base sm:text-lg font-semibold mb-2">
                  Partner school spotlight: building a culture of kindness
                </h3>
                <p className="mb-3 text-slate-100/80">
                  How one partner school is integrating the Eva Helpful Essential Values into everyday
                  routines.
                </p>
                <span className="mt-auto text-xs text-slate-300/90">Story to be published soon</span>
              </article>
            </div>
          </Reveal>
